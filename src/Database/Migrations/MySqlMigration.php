...
class MySqlMigration extends BaseMigration
{
    ...
    public function up(): string
    {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$tableName} ({$columnsSql}) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;";
